...
def load_training_vectors(csv_path: Path, output_directory = None):
    ...
    for _, row in df.iterrows():
        ...
        for index, spectrogram in enumerate(spectrograms):
            ...
            file_path = f'{output_directory}/{cleaned_name}_{index*10}s'
...
load_training_vectors(Path("/Users/rishi/MoodySound/data/mood.csv"), Path("/Users/rishi/MoodySound/dataset/train"))
